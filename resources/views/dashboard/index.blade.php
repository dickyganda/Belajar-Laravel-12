...
<html lang="en">
  <head>
    ...
    <title>Laravel 12 Custom Dashboard - DevScriptSchool.com</title>
        ...
        <div class="row">
            <div class="col-md-11">
                <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                    <img src="https://www.yourdomain.com/assets/images/logo-it-2.png" alt="BootstrapBrain Logo" width="300">
                </a>          
            </div>
            <div class="col-md-1">
